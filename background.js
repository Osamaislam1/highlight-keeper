...
async function saveHighlight(noteText, tab) { // Updated to accept only two parameters
try {
  const note = {
...
if (request.action === 'saveHighlight') {
  saveHighlight(request.text, sender.tab); // Updated to pass only two arguments
